...
var routes = []Route{
	...
	{Method: http.MethodGet, Path: "/api/v2/users/:user_id/username-history", BearerAuth: true, ExpectedStatus: http.StatusUnauthorized},
	...
	{Method: http.MethodGet, Path: "/api/v2/admin/flavors", BearerAuth: true, ExpectedStatus: http.StatusUnauthorized},
	...
	{Method: http.MethodPost, Path: "/api/v2/admin/flavors/:flavor_id/enable", BearerAuth: true, ExpectedStatus: http.StatusUnauthorized},
	{Method: http.MethodDelete, Path: "/api/v2/admin/flavors/:flavor_id", BearerAuth: true, ExpectedStatus: http.StatusUnauthorized},
	{Method: http.MethodGet, Path: "/api/v2/admin/cuisines", BearerAuth: true, ExpectedStatus: http.StatusUnauthorized},
	...
	{Method: http.MethodPost, Path: "/api/v2/admin/cuisines/:cuisine_id/enable", BearerAuth: true, ExpectedStatus: http.StatusUnauthorized},
	{Method: http.MethodDelete, Path: "/api/v2/admin/cuisines/:cuisine_id", BearerAuth: true, ExpectedStatus: http.StatusUnauthorized},
	{Method: http.MethodGet, Path: "/api/v2/admin/canteens", BearerAuth: true, ExpectedStatus: http.StatusUnauthorized},
	...
	{Method: http.MethodPost, Path: "/api/v2/admin/canteens/:canteen_id/enable", BearerAuth: true, ExpectedStatus: http.StatusUnauthorized},
	...
	{Method: http.MethodGet, Path: "/api/v2/admin/canteen-windows", BearerAuth: true, ExpectedStatus: http.StatusUnauthorized},
	...
	{Method: http.MethodPost, Path: "/api/v2/admin/canteen-windows/:window_id/enable", BearerAuth: true, ExpectedStatus: http.StatusUnauthorized},
	...
	{Method: http.MethodGet, Path: "/api/v2/admin/tags", BearerAuth: true, ExpectedStatus: http.StatusUnauthorized},
	{Method: http.MethodGet, Path: "/api/v2/admin/tags/hot", BearerAuth: true, ExpectedStatus: http.StatusUnauthorized},
	{Method: http.MethodPatch, Path: "/api/v2/admin/tags/:tag_id", BearerAuth: true, ExpectedStatus: http.StatusUnauthorized},
	{Method: http.MethodPost, Path: "/api/v2/admin/tags/:tag_id/merge", BearerAuth: true, ExpectedStatus: http.StatusUnauthorized},
	{Method: http.MethodDelete, Path: "/api/v2/admin/tags/:tag_id", BearerAuth: true, ExpectedStatus: http.StatusUnauthorized},
	{Method: http.MethodPost, Path: "/api/v2/admin/tags/:tag_id/restore", BearerAuth: true, ExpectedStatus: http.StatusUnauthorized},
